...
from app.draw.pyglet.tree_bsp import BSPLeaf, BSPTree
...
class NTreeLeaf(BSPLeaf):
    ...
    def create_texture(self, n_net):
        ...
        img_data, img_width, img_height = n_net.get_texture2(self.x1, self.y1, self.x2, self.y2, 1)
...
class NTree(BSPTree):
    def __init__(self, depth, n_net):
        ...
        self.texture_zoom_threshold_percent = 0.03  # % of max_possible_zoom at which textures swap to vertices
    ...
    def create_textures(self, n_net, min_zoom, max_zoom):
        ...
        if self.depth > 0:
            for i in range(self.depth, 0, -1):
                img_data, img_width, img_height = n_net.get_texture2(0, 0, self.width, self.height, i*4)
    ...
    def draw_textures(self, n_shader):
        ...
        elif zoom < self.texture_zoom_threshold and len(self.textures) > 1:
